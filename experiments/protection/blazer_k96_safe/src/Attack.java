...
public class Attack {
    ...
    public static void prim(){
        ...
        for (int i=0; i < 10; i++){
            K96.modular_exponentiation_safe(pub1,input1,pub2,16);
            K96.modular_exponentiation_safe(pub1,input2,pub2,16);
        }
    ...
    public static void measure(BigInteger input){
        ...
        startTime = System.nanoTime();
        answer1 = K96.modular_exponentiation_safe(pub1, input, pub2, 16);
        endTime = System.nanoTime();
